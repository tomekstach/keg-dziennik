...
/**
 * Strings for component 'block_kegblock', language 'en', branch 'MOODLE_20_STABLE'
 *
...
$string['kegblock:addinstance'] = 'Add a new KEG block';
$string['kegblock:myaddinstance'] = 'Add a new KEG block to Dashboard';
$string['kegblock'] = 'KEG block';
$string['pluginname'] = 'KEG block';
$string['managestudents'] = 'Students';
$string['addstudents'] = 'Add students';
$string['manageteachers'] = 'Teachers';
$string['addteachers'] = 'Add teacher';
